...
import { Button, FormControl, TextField, Toolbar } from "@mui/material";
...
const ContactUs = () => {
  ...
  const meta_title = " MJFACTOR - How You Can Reach Us";
      ...
      >
        ...
        <Container>
          <Box sx={{ background: "", color: "#737A85", py: 4 }}>
            ...
            >
              Kindly be as detailed as possible, stating all relevant
              information you already have, including any contacts, to help us
              understand your enquiry and help us find the right person to
              handle your request.
            </Box>
            {/* <Divider
                sx={{
